...
namespace Api.Totem.Domain.Interfaces.Repositories
{
	...
	{
		IEnumerable<TEntity> List(Dictionary<string, dynamic> conditions = null, List<string> attributesToGet = null);
		...
		void Delete(Dictionary<string, dynamic> conditions = null);
	}
}
